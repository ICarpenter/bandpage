module.exports = function (grunt) {
    ...
    function bower() {
        return path.join.apply(null, ['../js/bower_components/'].concat(__slice.call(arguments)));
    }
    ...
    var config = {
        ...
        copy: {
            target: {
                files: {
                    "<%= vendor('moment.js') %>"                   : "<%= bower('moment/moment.js') %>",
                    "<%= vendor('angular.js') %>"                  : "<%= bower('angular/angular.js') %>",
                    "<%= vendor('jquery.js') %>"                   : "<%= bower('jquery/dist/jquery.js') %>",
                    "<%= vendor('angular-sanitize.js') %>"         : "<%= bower('angular-sanitize/angular-sanitize.js') %>",
                    "<%= vendor('angular-animate.js') %>"          : "<%= bower('angular-animate/angular-animate.js') %>",
                    "<%= vendor('angular-scroll.js') %>"           : "<%= bower('angular-scroll/angular-scroll.js') %>",
                    "<%= vendor('angular-ui-router.js') %>"        : "<%= bower('angular-ui-router/release/angular-ui-router.js') %>",
